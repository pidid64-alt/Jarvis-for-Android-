...
object GeminiClient {
    ...
    private const val SYSTEM_PROMPT =
        ...
        "Ты также умеешь управлять телефоном офлайн-командами: «включи фонарик», «выключи фонарик», «включи вайфай», " +
        "«открой <приложение>», «позвони <имя>», «напиши <имя>», «будильник на 7:30», «таймер на 5 минут», " +
        "«сколько заряда», «который час», «маршрут до <места>», «найди <запрос>», «включи музыку», «громче/тише». " +
