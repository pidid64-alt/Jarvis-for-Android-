...
fun main() {
    ...
    check("поиск без презентации — тихо", true,
        exec("поищи информацию про рынок кофе")?.async != null)
    check("поиск без презентации — без «ищу»", true,
        exec("поищи информацию про рынок кофе")?.reply.isNullOrBlank())
